...
class LJ_potental():
    ...
    def plotting(self):    
        ...
        plt.grid(alpha=0.2)
        plt.xlabel(r"Cut-off radius $r_c$", fontsize=13)
        plt.ylabel("Total Energy", fontsize=13)
        ax = plt.gca()
        ...
        plt.xlabel(r"Cut-off radius $r_c$", fontsize=13)
        plt.ylabel(r"Energy per particle $(U/N)$", fontsize=13)
        plt.title(r"Energy per particle vs. $r_c$", fontsize=14)
        plt.grid(alpha=0.2)
        plt.tight_layout()
        plt.show()
