...
Improvements include the addition of the cross-entropy cost function, regularization, and better initiallization of network weights.
It also uses softmax as an activation function instead of sigmoid.
