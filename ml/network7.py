"""network7.py
______________
An improved version of network.py, implementing the momentum based Gradient Descent learning algorithm for a FFNN.
...
class network():
    def __init__(self, sizes, cost=CrossEntropyCost, dropout_rate = 0.2):
